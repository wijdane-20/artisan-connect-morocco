    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="inline-flex items-center justify-center rounded-md border bg-background px-4 py-2 text-sm font-medium hover:bg-accent">Accueil</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ArtisanConnect — Trouvez les meilleurs artisans au Maroc" },
      { name: "description", content: "Plateforme marocaine qui connecte particuliers et artisans qualifiés : plombiers, électriciens, menuisiers, peintres et plus." },
      { property: "og:title", content: "ArtisanConnect" },
      { property: "og:description", content: "Trouvez l'artisan qu'il vous faut au Maroc." },
